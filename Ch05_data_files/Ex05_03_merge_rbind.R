...
write.table(a1, "~/Learning/temp/longley.a1.txt", sep="\t")
write.table(a2, "~/Learning/temp/longley.a2.txt", sep="\t")
write.table(b, "~/Learning/temp/longley.b.txt", sep="\t")
rm(list=ls()) # Clear out everything to start fresh

# Import data
a1t <- read.table("~/Learning/temp/longley.a1.txt", sep="\t")
a2t <- read.table("~/Learning/temp/longley.a2.txt", sep="\t")
...
b <- read.table("~/Learning/temp/longley.b.txt", sep="\t")
